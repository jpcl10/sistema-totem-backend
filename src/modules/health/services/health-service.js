...
import { getPrintProcessingStatus } from '../../../infra/print-processing/print-processing-coordinator.js';
...
export class HealthService {
    async execute() {
        ...
        const status = databaseResult === 'ok' && redisResult.status !== 'unavailable'
            ? 'ok'
            : databaseResult === 'ok'
                ? 'degraded'
                : 'error';
