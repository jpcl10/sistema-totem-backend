...
import { AmbiguousEventSlugError, buildAmbiguousEventSlugResponse, PublicEventNotFoundError, resolveLegacyPublicEventSlug } from '../services/public-event-resolver.js';
export async function getPublicEventCatalogMenuController(request, reply) {
    ...
    const service = new GetPublicEventCatalogMenuService();
