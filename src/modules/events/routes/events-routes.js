...
export async function eventsRoutes(app) {
    ...
    app.get('/public/organizations/:organizationSlug/events/:eventSlug/menu', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/public/organizations/:organizationSlug/events/:eventSlug/catalog-menu', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/public/events/:slug/menu', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/public/events/:slug/catalog-menu', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/events/:eventId/closing-preview', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.get('/events/:eventId/closing', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.post('/events/:eventId/reopen', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.patch('/events/:eventId/archive', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.patch('/events/:eventId/restore', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
