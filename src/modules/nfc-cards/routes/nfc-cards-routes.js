...
export async function nfcCardsRoutes(app) {
    // Public route for totem NFC identification
    app.post('/public/organizations/:organizationSlug/events/:eventSlug/nfc/identify', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.post('/public/events/:eventSlug/nfc/identify', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.post('/public/organizations/:organizationSlug/events/:eventSlug/orders/:orderId/pay-with-nfc-balance', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.post('/public/events/:eventSlug/orders/:orderId/pay-with-nfc-balance', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.post('/events/:eventId/nfc-cards', {
    ...
    app.get('/events/:eventId/nfc-cards', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.get('/events/:eventId/nfc-cards/uid/:uid', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.patch('/events/:eventId/nfc-cards/:id', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.post('/events/:eventId/nfc-cards/:id/block', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.post('/events/:eventId/nfc-cards/read', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.get('/events/:eventId/nfc-cards/:id/reads', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    // Balance operations
    app.post('/events/:eventId/nfc-cards/:id/topup', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.post('/events/:eventId/nfc-cards/:id/debit', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.post('/events/:eventId/nfc-cards/:id/adjust', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.post('/events/:eventId/nfc-cards/:id/refund', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.get('/events/:eventId/nfc-cards/:id/transactions', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
