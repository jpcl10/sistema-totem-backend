...
export async function superAdminRoutes(app) {
    // Organizations
    app.get('/super-admin/organizations', { preHandler: [verifyJWT, requirePlatformContext] }, listOrganizationsController);
    app.get('/super-admin/organizations/:id', { preHandler: [verifyJWT, requirePlatformContext] }, getOrganizationController);
    app.post('/super-admin/organizations', { preHandler: [verifyJWT, requirePlatformContext] }, createOrganizationController);
    app.patch('/super-admin/organizations/:id', { preHandler: [verifyJWT, requirePlatformContext] }, updateOrganizationController);
    app.patch('/super-admin/organizations/:id/modules', { preHandler: [verifyJWT, requirePlatformContext] }, updateOrganizationModulesController);
    // Users
    app.get('/super-admin/users', { preHandler: [verifyJWT, requirePlatformContext] }, listSuperAdminUsersController);
    app.post('/super-admin/users', { preHandler: [verifyJWT, requirePlatformContext] }, createSuperAdminUserController);
}
