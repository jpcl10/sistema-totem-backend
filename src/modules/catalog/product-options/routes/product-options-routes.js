...
export async function productOptionsRoutes(app) {
    // Option Groups
    app.post('/catalog/products/:productId/option-groups', {
    ...
    app.get('/catalog/products/:productId/option-groups', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.put('/catalog/option-groups/:groupId', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.patch('/catalog/option-groups/:groupId/status', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    // Options
    app.post('/catalog/option-groups/:groupId/options', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.put('/catalog/options/:optionId', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.patch('/catalog/options/:optionId/status', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
