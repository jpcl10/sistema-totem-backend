...
export function formatOptionGroups(product: any) {
  return product.optionGroups.map((group: any) => ({
    id: group.id,
    name: group.name,
...
export function formatEventProduct(eventProduct: any) {
...
export function formatAvailableCatalogProduct(
  product: any,
