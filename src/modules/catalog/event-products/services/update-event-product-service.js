...
export class UpdateEventProductService {
    async execute({ organizationId, userId, eventId, eventProductId, priceInCents, trackStock, stockQuantity, soldOut, active }) {
        ...
        const updatedEventProduct = await prisma.eventProduct.update({
            where: {
                id: eventProductId
            },
            data: {
