...
export async function updateEventProductController(request, reply) {
    const params = request.params;
    const body = updateEventProductSchema.parse(request.body);
    const userId = request.user.sub;
    const organizationId = getTenantOrganizationId(request);
    const service = new UpdateEventProductService();
    try {
