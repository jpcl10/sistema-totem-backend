...
export async function createCatalogProductController(request, reply) {
    const body = createCatalogProductSchema.parse(request.body);
    const userId = request.user.sub;
    const organizationId = getTenantOrganizationId(request);
    const service = new CreateCatalogProductService();
