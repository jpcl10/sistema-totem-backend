...
import { getPublicEventCallScreenController, getPublicStoreCallScreenController, listPublicEventCallScreenOrdersController, listPublicStoreCallScreenOrdersController } from '../controllers/public-call-screen-controller.js';
...
export async function ordersRoutes(app) {
    app.post('/public/organizations/:organizationSlug/events/:eventSlug/orders', {
    ...
    app.post('/public/events/:slug/orders', {
        preHandler: [tryVerifyDeviceJWT],
        config: {
            rateLimit: {
                max: 60,
    ...
    app.patch('/orders/unified/:orderType/:orderId/payment', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.get('/events/:eventId/financial-summary', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.patch('/orders/:orderId/payment-status', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.patch('/orders/:orderId/payment', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.get('/public/organizations/:organizationSlug/events/:eventSlug/orders', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/public/events/:slug/orders', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/public/call-screens/store/:slug', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/public/call-screens/store/:slug/orders', {
        config: {
            rateLimit: {
                max: 120,
                timeWindow: '1 minute'
    ...
    app.get('/public/call-screens/organizations/:organizationSlug/events/:eventSlug', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/public/call-screens/organizations/:organizationSlug/events/:eventSlug/orders', {
        config: {
            rateLimit: {
                max: 120,
                timeWindow: '1 minute'
    ...
    app.get('/public/call-screens/event/:slug', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/public/call-screens/event/:slug/orders', {
        config: {
            rateLimit: {
                max: 120,
                timeWindow: '1 minute'
    ...
    app.get('/public/organizations/:organizationSlug/events/:eventSlug/call-screen-orders', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/public/events/:slug/call-screen-orders', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.post('/events/:eventId/orders/manual-sale', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 120,
