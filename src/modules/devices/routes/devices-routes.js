...
export async function devicesRoutes(app) {
    ...
    app.get('/devices/print-jobs/pending', {
        preHandler: verifyDeviceJWT,
        config: {
            rateLimit: {
                max: 300,
    ...
    app.patch('/devices/print-jobs/:id/printed', {
        preHandler: verifyDeviceJWT,
        config: {
            rateLimit: {
                max: 300,
    ...
    app.patch('/devices/print-jobs/:id/error', {
        preHandler: verifyDeviceJWT,
        config: {
            rateLimit: {
                max: 300,
    ...
    app.post('/devices/:id/regenerate-credentials', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
