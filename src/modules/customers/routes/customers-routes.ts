...
import {
  ...
  removeCustomerInterestController,
  updateCustomerAddressController,
  updateCustomerAddressStatusController,
  updateCustomerController,
  updateCustomerStatusController,
  updateInterestController,
  updateInterestStatusController
...
export async function customersRoutes(app: FastifyInstance) {
  ...
  app.patch(
    '/customers/:customerId/addresses/:addressId/status',
    { preHandler: tenantPreHandler },
    updateCustomerAddressStatusController
  )
  ...
  app.delete(
    '/customers/:customerId/interests/:interestId',
    { preHandler: tenantPreHandler },
    removeCustomerInterestController
  )
}
