...
export const updateBusinessHourExceptionSchema = createBusinessHourExceptionSchema.partial();
...
export const updateDeliveryFeeRuleSchema = deliveryFeeRuleInputSchema
    .omit({ storeId: true })
    .partial()
    .superRefine((data, ctx) => {
