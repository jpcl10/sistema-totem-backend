...
export async function printJobsRoutes(app) {
    app.get('/events/:eventId/print-jobs', {
    ...
    app.patch('/print-jobs/:printJobId/cancel', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.patch('/print-jobs/:printJobId/printed', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
    ...
    app.patch('/print-jobs/:printJobId/retry', {
        preHandler: [verifyJWT, requireTenantContext],
        config: {
            rateLimit: {
                max: 300,
