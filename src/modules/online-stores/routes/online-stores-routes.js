...
export async function onlineStoresRoutes(app) {
    // Public routes
    app.get('/public/stores/:slug', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/public/stores/:slug/customers/by-phone', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.get('/public/stores/:slug/customers/:customerId/orders', {
        config: {
            rateLimit: {
                max: 60,
                timeWindow: '1 minute'
    ...
    app.post('/public/stores/:slug/orders', {
        config: {
            rateLimit: {
                max: 30,
                timeWindow: '1 minute'
    ...
    // Admin routes
    app.get('/online-stores', { preHandler: [verifyJWT, requireTenantContext] }, listOnlineStoresController);
    app.post('/online-stores', { preHandler: [verifyJWT, requireTenantContext] }, createOnlineStoreController);
    app.get('/online-stores/:id', { preHandler: [verifyJWT, requireTenantContext] }, getOnlineStoreController);
    app.patch('/online-stores/:id', { preHandler: [verifyJWT, requireTenantContext] }, updateOnlineStoreController);
    app.get('/online-stores/:storeId/summary', { preHandler: [verifyJWT, requireTenantContext] }, getOnlineStoreSummaryController);
    app.get('/online-stores/:storeId/availability', { preHandler: [verifyJWT, requireTenantContext] }, getOnlineStoreAvailabilityController);
    app.patch('/online-stores/:storeId/availability', { preHandler: [verifyJWT, requireTenantContext] }, updateOnlineStoreAvailabilityController);
    app.get('/online-stores/:storeId/orders', { preHandler: [verifyJWT, requireTenantContext] }, listOnlineOrdersController);
    app.post('/online-stores/:storeId/orders/manual-sale', { preHandler: [verifyJWT, requireTenantContext] }, createManualOnlineOrderController);
    app.patch('/online-orders/:orderId/status', { preHandler: [verifyJWT, requireTenantContext] }, updateOnlineOrderStatusController);
}
