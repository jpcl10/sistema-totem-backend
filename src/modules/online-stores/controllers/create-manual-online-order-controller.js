...
import { createManualOnlineOrderParamsSchema, createManualOnlineOrderSchema } from '../schemas/create-manual-online-order-schema.js';
...
export async function createManualOnlineOrderController(request, reply) {
    try {
        ...
        if (error instanceof Error) {
            ...
            if (error.message === 'Store is currently unavailable' ||
