...
import { onlineStoreAvailabilityParamsSchema, updateOnlineStoreAvailabilitySchema } from '../schemas/online-store-availability-schema.js';
export async function updateOnlineStoreAvailabilityController(request, reply) {
